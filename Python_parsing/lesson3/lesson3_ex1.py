...
from pymongo import MongoClient, errors as err
...
while True:
    ...
    for vacancy in vacancy_list:
        ...
        # не уверен уникальные ли номера вакансий в ссылке, но наверное да
        vacancy_data['_id'] = int(vacancy_link.split('/')[4].split('?')[0])
        ...
        try:
            ...
            print('Такая вакансия уже существует!' + str(vacancy_data['link']))
