...
class HhruSpider(scrapy.Spider):
    ...
    start_urls = ['https://hh.ru/search/vacancy?area=1&fromSearchLine=true&text=python',
                  'https://hh.ru/search/vacancy?fromSearchLine=true&text=python&area=232&search_field=description&search_field=company_name&search_field=name',
                  'https://hh.ru/search/vacancy?fromSearchLine=true&text=python&area=231&search_field=description&search_field=company_name&search_field=name']
